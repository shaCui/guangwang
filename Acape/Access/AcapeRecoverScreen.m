...
@implementation AcapeRecoverScreen
...
- (void)buildHeader {
    ...
    self.titleLabel = [[AcapeGradientCaptionLabel alloc] initWithFontSize:36.0];
    self.titleLabel.text = AcapeRevealText(AcapeRevealTextKeyRecoverTitle);
    ...
    [NSLayoutConstraint activateConstraints:@[
        ...
        [self.titleLabel.trailingAnchor constraintLessThanOrEqualToAnchor:self.view.safeAreaLayoutGuide.trailingAnchor constant:-24.0],
    ]];
}
...
- (void)buildFormPanel {
    ...
    [self.submitButton setTitle:AcapeRevealText(AcapeRevealTextKeyAdvanceAction) forState:UIControlStateNormal];
